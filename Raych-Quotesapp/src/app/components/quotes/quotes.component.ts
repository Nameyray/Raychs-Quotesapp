...
export class QuotesComponent implements OnInit {
 quotes: Quotes[]= [
  ...
  new Quotes (4, 'Grace','He who began His work in you will be faithful enough to finish it','Chandler Moore',new Date(2022,4,9), 0, 0),
  new Quotes (5, 'Grace','You learn to do it after several atempts','Ashley Shirer',new Date(2022,4,9), 0, 0),
